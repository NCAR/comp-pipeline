...
function comp_fix_image, data, old_data=old_data
  ...
  if (keyword_set(old_data)) then begin
    data2[0, 512:1023] = data[0, 512:1023]  ; put bad columns at left edge of image
    ...
    data2[4:258, 512:1023] = data[1:255, 512:1023]  ; squeeze image back
    ...
    data2[4:258, 0:511] = data[0:254, 0:511]  ; squeeze image back
    ...
    data2[0, 0:1023] = data[0, 0:1023]  ; put bad columns at left edge of image
    data2[1, 0:1023] = data[256, 0:1023]
    data2[2, 0:1023] = data[512, 0:1023]
    data2[3, 0:1023] = data[768, 0:1023]

    data2[4:258, 0:1023] = data[1:255, 0:1023]  ; squeeze image back
