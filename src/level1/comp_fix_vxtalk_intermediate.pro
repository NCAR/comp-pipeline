...
pro comp_fix_vxtalk, date_dir, vimages, vheaders, filename
  ...
  comp_demodulate, quimages, quheaders, quimages_demod, quheaders_demod
	...
	mask0=comp_raw_mask(date_dir,vheaders,upper_left_mask=mask1, lower_right_mask=mask2)
	...
	comp_find_vxtalk,date_dir,Ibg,Qbg,Ubg,Vbg,vheaders,IVxtalk,QVxtalk,UVxtalk,xtparms
  ...
  comp_plot_vxtalk, Ibg, Qbg, Ubg, Vbg, IVxtalk, QVxtalk, UVxtalk, mask0, calplot_file, qub, qub, qub, fnb
