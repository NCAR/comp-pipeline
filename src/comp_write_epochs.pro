...
pro comp_write_epochs, date_dir
  ...
  printf, lun, 'post_angle_guess', post_angle_guess, format='(%"%-25s : %0.1f")'
  printf, lun, 'post_angle_tolerance', post_angle_tolerance, format='(%"%-25s : %0.1f")'

  printf, lun

  printf, lun, 'gbu_max_background', gbu_max_background, format='(%"%-25s : %0.1f")'
  printf, lun, 'gbu_min_background', gbu_min_background, format='(%"%-25s : %0.1f")'
  printf, lun, 'gbu_med_background', gbu_med_background, format='(%"%-25s : %0.1f")'
  printf, lun, 'gbu_max_sigma', gbu_max_sigma, format='(%"%-25s : %0.1f")'
  ...
  printf, lun, 'gbu_background_threshold', gbu_background_threshold, $
          format='(%"%-25s : %0.1f")'
  printf, lun, 'gbu_theshold_count', gbu_threshold_count, format='(%"%-25s : %0.1f")'
