...
;-
function comp_coregister2, img0_in, img1_in, index0_in, index1_in, mask_in, err0_in=err0_in, err1_in=err1_in, smooth_radius=smooth_radius, guess=guess, img1_out=img1_out, index1_out=index1_out, show_result=show_result
	...
	if(n_elements(guess) eq 0) then guess = [0,0,0]
